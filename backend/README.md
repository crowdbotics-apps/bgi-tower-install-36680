...
## Project Structure
    ...
    ├── bgi_tower_install_36680  # Django project configurations
...
1. Clone this repo and `cd bgi_tower_install_36680`
...
2. Clone this repo and `cd bgi_tower_install_36680`
